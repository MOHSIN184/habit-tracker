...
def render_manage_section() -> None:
    ...
    with st.expander("Manage habits", expanded=len(habits) <= 3):
...
def render_empty_state() -> None:
    st.markdown(
        ...
        <div class='empty-state'>
            <h3>No habits yet</h3>
            <p>Start by adding one habit above. Once you create habits, the weekly tracking grid will appear here.</p>
